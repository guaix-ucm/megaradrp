...
class MegaraDetector(CCDDetector):
    ...
    def __init__(self):
        amplifiers = [Amplifier(shape=(slice(0, 2048), slice(0, 4096)),
                                gain=2.4, ron=6, wdepth=66000),
                      Amplifier(shape=(slice(2048, 4096), slice(0, 4096)),
                                gain=2.4, ron=6, wdepth=66000)]
        CCDDetector.__init__(
            self, shape=(4096, 4096), amplifiers=amplifiers,
            bias=100, dark=0.3)
