...
@pytest.mark.parametrize("name, confid, nbundles, nfibers", [BASE_LCB, BASE_MOS])
...
def test_sky_fibers(ignored, fibs):
    ...
    skyfibs = conf.sky_fibers(valid_only=True, ignored_bundles=ignored)
