...
from megaradrp.processing.wcs import compute_pa_from_ipa
from megaradrp.processing.wcs import update_wcs_from_ipa
...
@pytest.mark.parametrize("cdelt1", [0.1, -0.1])
@pytest.mark.parametrize(
    "pa",
    [
        0.0,
